...
import bonch.dev.R
import bonch.dev.data.driver.signup.SignupStatusModel
...
import bonch.dev.domain.utils.Constants.DRIVER_DOC_BACK
import bonch.dev.domain.utils.Constants.DRIVER_DOC_FRONT
import bonch.dev.domain.utils.Constants.DRIVER_SIGNUP_CHECK_PHOTO
import bonch.dev.domain.utils.Constants.DRIVER_SIGNUP_COMPLETE
import bonch.dev.domain.utils.Constants.DRIVER_SIGNUP_DOCS_VIEW
import bonch.dev.domain.utils.Constants.DRIVER_SIGNUP_PROCESS
import bonch.dev.domain.utils.Constants.DRIVER_SIGNUP_START
import bonch.dev.domain.utils.Constants.GALLERY
import bonch.dev.domain.utils.Constants.PASSPORT_ADDRESS_PHOTO
import bonch.dev.domain.utils.Constants.PASSPORT_PHOTO
import bonch.dev.domain.utils.Constants.SELF_PHOTO_PASSPORT
import bonch.dev.domain.utils.Constants.STS_DOC_BACK
import bonch.dev.domain.utils.Constants.STS_DOC_FRONT
import bonch.dev.domain.utils.Constants.USER_PHOTO
